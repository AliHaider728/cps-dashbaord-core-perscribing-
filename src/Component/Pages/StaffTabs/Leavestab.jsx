    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-secondary text-sm mt-1">View and manage staff leave requests</p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        <div className="bg-primary rounded-xl border border-border p-4 hover:shadow-md transition-shadow">
          ...
          <div className="text-sm text-secondary mt-1">Total Requests</div>
        </div>
        ...
        <div className="bg-blue-50 rounded-xl border border-blue-200 p-4 hover:shadow-md transition-shadow">
          ...
          <div className="text-sm text-blue-700 mt-1">Days Approved</div>
        </div>
      </div>
      ...
      {filteredLeaves.length > 0 ? (
        ...
        <div className="bg-primary rounded-xl border border-border p-12 text-center">
          <div className="w-20 h-20 bg-core-primary-50 rounded-full flex items-center justify-center mx-auto mb-4">
            <Umbrella className="text-core-primary-500" size={40} />
          </div>
          <h3 className="text-xl font-semibold text-primary mb-2">No Leave Requests Found</h3>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 bg-primary border border-border rounded-lg text-primary focus:outline-none focus:ring-2 focus:ring-core-primary-500"
                    />
                  </div>
                </div>
                <div>
