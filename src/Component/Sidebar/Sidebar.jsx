    ...
    const menuItems = [
        ...
        { icon: UserCircle, label: 'Non-PCN Clients', id: 'non-pcn' },
    ...
    return (
        ...
        >
            ...
            <style>{`
                ...
                nav::-webkit-scrollbar-thumb {
                    background: var(--core-primary-300); /* Lighter color variant - adjust if your theme has a different light primary */
                    border-radius: 10px;
                }
                nav::-webkit-scrollbar-thumb:hover {
