  ...
  const leaveData = [
    {
      ...
      requester: { 
        ...
        email: 'hassan.raza@coreprescribing.com',
        department: 'Management',
        leaveBalance: 156.00,
        contractHours: 2080,
        workingDays: 260,
        leavesBookedThisMonth: 0,
        totalLeavesBooked: 24,
      ...
      additionalInfo: 'Family wedding - Manager cover required during this period',
      status: 'pending',
      approvers: ['Nadia Collins', 'Mark Thompson'],
      appliedDate: '2026-01-30',
      employee: 'Hassan Raza',
      projectName: 'North London Practice Group',
      startTime: '08:30',
      endTime: '17:00',
      approver: 'Nadia Collins, Mark Thompson',
      reason: '',
      coverRequired: true,
      coverAssigned: false,
      assignedCoverStaff: null,
      workingDays: 3,
      requestNotes: 'This is a planned family event. Will complete all pending tasks before leave.',
      lineManager: 'Nadia Collins',
      department: 'Management',
      submittedOn: '2026-01-30 14:23',
      lastUpdated: '2026-01-30 14:23',
      monthBooked: 1 // February (0-indexed)
    },
    {
      id: 102,
      requester: { 
        ...
        email: 'sara.mahmood@coreprescribing.com',
        department: 'Clinical Services',
        leaveBalance: 45.50,
        contractHours: 2080,
        workingDays: 260,
        leavesBookedThisMonth: 7.5,
        totalLeavesBooked: 156,
      ...
      additionalInfo: 'Flu symptoms - Medical certificate will be provided',
      status: 'approved',
      approvers: ['Daniel Foster'],
      appliedDate: '2026-03-02',
      employee: 'Sara Mahmood',
      projectName: 'Westfield Health Network',
      startTime: '09:00',
      endTime: '16:30',
      approver: 'Daniel Foster',
      reason: 'Approved - Medical leave as per policy. Cover arranged with Dr. Emily Turner.',
      coverRequired: true,
      coverAssigned: true,
      assignedCoverStaff: {
      ...
      workingDays: 1,
      requestNotes: 'Feeling unwell with fever and body aches. Will provide medical certificate.',
      lineManager: 'Daniel Foster',
      department: 'Clinical Services',
      submittedOn: '2026-03-02 08:15',
      lastUpdated: '2026-03-02 09:30',
      approvedDate: '2026-03-02 09:30',
      approvedBy: 'Daniel Foster',
      monthBooked: 2 // March
    },
    {
      id: 103,
      requester: { 
        ...
        email: 'john.smith@coreprescribing.com',
        department: 'Clinical Services',
        leaveBalance: 180.00,
        contractHours: 2080,
        workingDays: 260,
        leavesBookedThisMonth: 15,
        totalLeavesBooked: 45,
        complianceStatus: 'compliant',
        trainingsDue: 0,
        documentsDue: 0
      },
      ...
      toDate: '2026-02-22',
      hours: 22.5,
      leaveType: 'Annual Leave (non-PCN)',
      additionalInfo: 'Pre-planned vacation',
      status: 'pending',
      approvers: ['Daniel Foster'],
      ...
      assignedCoverStaff: null,
      workingDays: 3,
      requestNotes: 'Planned family trip',
      lineManager: 'Daniel Foster',
      department: 'Clinical Services',
      submittedOn: '2026-01-29 10:15',
      lastUpdated: '2026-01-29 10:15',
      monthBooked: 1 // February
    }
  ];
