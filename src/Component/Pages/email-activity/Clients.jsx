...
const GLOBAL = `
  ...
  .ec-row:hover .ec-delete-btn { opacity:1; }
  .ec-delete-btn:hover { color:#ef4444 !important; background-color:rgba(239,68,68,0.08) !important; }
`;
...
function DeleteModal({ client, onConfirm, onClose, isDeleting }) {
      ...
      <div className="relative w-full max-w-md rounded-2xl shadow-2xl overflow-hidden" style={{ ...surfaceStyle, animation:"ec-modalIn .18s ease both" }}>
        <div className="p-6 text-center">
          ...
          <p className="text-xs mb-6" style={textMuted}>
            This will also remove all associated emails and timeline entries. This action cannot be undone.
          </p>
          <div className="flex gap-3">
            <button onClick={onClose}
              className="flex-1 py-2.5 text-sm font-semibold rounded-xl ec-ghost-btn"
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-0.5">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center shadow-md"
              style={{ background:BRAND_GRAD, boxShadow:"0 4px 10px rgba(102,115,255,0.35)" }}>
                  ...
                  <tr key={c.id} className="ec-row" onClick={() => navigate(`/email-activity/clients/${c.id}`)}>
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold shrink-0 text-white shadow-sm"
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full"
                              style={{ backgroundColor:cv("--border-color"), ...textMuted }}>{c.pcnNumber}</span>
